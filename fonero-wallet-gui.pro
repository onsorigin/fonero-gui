...
WALLET_ROOT=$$PWD/fonero

CONFIG += c++11

# cleaning "auto-generated" bitfonero directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently fonero has an issue with "static" build and linunwind-dev,
...
TRANSLATIONS =  \ # English is default language, no explicit translation file
                $$PWD/translations/fonero-gui.ts \ # translation source (copy this file when creating a new translation)
                $$PWD/translations/fonero-gui_ar.ts \ # Arabic
                $$PWD/translations/fonero-gui_pt-br.ts \ # Portuguese (Brazil)
                $$PWD/translations/fonero-gui_de.ts \ # German
                $$PWD/translations/fonero-gui_eo.ts \ # Esperanto
                $$PWD/translations/fonero-gui_es.ts \ # Spanish
                $$PWD/translations/fonero-gui_fi.ts \ # Finnish
                $$PWD/translations/fonero-gui_fr.ts \ # French
                $$PWD/translations/fonero-gui_hr.ts \ # Croatian
                $$PWD/translations/fonero-gui_id.ts \ # Indonesian
                $$PWD/translations/fonero-gui_hi.ts \ # Hindi
                $$PWD/translations/fonero-gui_it.ts \ # Italian
                $$PWD/translations/fonero-gui_ja.ts \ # Japanese
                $$PWD/translations/fonero-gui_nl.ts \ # Dutch
                $$PWD/translations/fonero-gui_pl.ts \ # Polish
                $$PWD/translations/fonero-gui_ru.ts \ # Russian
                $$PWD/translations/fonero-gui_sv.ts \ # Swedish
                $$PWD/translations/fonero-gui_zh-cn.ts \ # Chinese (Simplified-China)
                $$PWD/translations/fonero-gui_zh-tw.ts \ # Chinese (Traditional-Taiwan)
                $$PWD/translations/fonero-gui_he.ts \ # Hebrew
                $$PWD/translations/fonero-gui_ko.ts \ # Korean
                $$PWD/translations/fonero-gui_ro.ts \ # Romanian
...
android{
    deploy.commands += make install INSTALL_ROOT=$$DESTDIR && androiddeployqt --input android-libfonero-wallet-gui.so-deployment-settings.json --output $$DESTDIR --deployment bundled --android-platform android-21 --jdk /usr/lib/jvm/java-8-openjdk-amd64 -qmldir=$$PWD
}
...
DISTFILES += \
    notes.txt \
    fonero/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = fonero-gui.rc
