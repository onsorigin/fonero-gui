...
AddressBook::AddressBook(Fonero::AddressBook *abImpl,QObject *parent)
...
QList<Fonero::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Fonero::AddressBookRow * AddressBook::getRow(int index) const
{
