...
public:
    enum LogLevel {
        LogLevel_Silent = Fonero::WalletManagerFactory::LogLevel_Silent,
        LogLevel_0 = Fonero::WalletManagerFactory::LogLevel_0,
        LogLevel_1 = Fonero::WalletManagerFactory::LogLevel_1,
        LogLevel_2 = Fonero::WalletManagerFactory::LogLevel_2,
        LogLevel_3 = Fonero::WalletManagerFactory::LogLevel_3,
        LogLevel_4 = Fonero::WalletManagerFactory::LogLevel_4,
        LogLevel_Min = Fonero::WalletManagerFactory::LogLevel_Min,
        LogLevel_Max = Fonero::WalletManagerFactory::LogLevel_Max,
    };
