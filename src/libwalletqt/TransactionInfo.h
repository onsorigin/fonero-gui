...
public:
    enum Direction {
        Direction_In  =  Fonero::TransactionInfo::Direction_In,
        Direction_Out =  Fonero::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Fonero::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Fonero::TransactionInfo * m_pimpl;
